...
public class Client {
	 ...
	 * @throws IOException If there's an issue with sending the request.
	 */
	public void initiateGlobalState () throws IOException{
		this.rpcServer.initiateGlobalState();
	}
